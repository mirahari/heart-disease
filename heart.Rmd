...
```{r sex, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r hrate, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r hrate2, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r cp, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r exang, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r thal.tb, message = FALSE, warning = FALSE, results='asis', echo=FALSE}
...
```{r thal, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r stdep, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r slope, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r unprune, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r unprune.summary, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r unprune.test, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r cv, message = FALSE, warning = FALSE, out.width='100%', echo=FALSE}
...
```{r prune, message = FALSE, warning = FALSE, out.width='100%', echo=FALSE}
...
```{r prune.summary, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r prune.tree, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r prune.test, message = FALSE, warning = FALSE, echo=FALSE}
